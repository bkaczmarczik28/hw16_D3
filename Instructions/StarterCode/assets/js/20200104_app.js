...
function XScale(censusData, chosenAxis) {
    // extending scale range by 2 to optimize chart space without having data go over axis
	var xLinearScale = d3.scaleLinear()
    .domain([d3.min(censusData, d => d[chosenAxis]), d3.max(censusData, d => d[chosenAxis])])
    .range([0, chartWidth]);
